...
import { getSchedules, upsertSchedule, deleteSchedule, bulkUpsertSchedules } from '../controllers/schedules'
import { downloadScheduleTemplate, importSchedules, scheduleUpload } from '../controllers/scheduleImport'
import { getServiceTrips, getLandfillTrips, triggerMonitoring, getServiceStats, getDiagnostic, getAnomalyHistory } from '../controllers/trips'
...
import { getSupervisorOverview, getSupervisorAiOverview, getSupervisorDaily, getSupervisorMap } from '../controllers/supervisor'
import { getDriverLeaderboard, exportLeaderboardExcel } from '../controllers/leaderboard'
import {
...
import { getCoveragePublic, verifyCoverage, startAiTraining, getAiStatus, startIncrementalTraining, getAiTrend, getAiMissedPatterns, getAiDebug, fetchMfyStreetsHandler, getStreetStatsHandler, getVehicleTrainingStatusHandler, trainSingleVehicleHandler, getDayCoverage } from '../controllers/coverageMap'
...
router.post('/schedules/bulk', bulkUpsertSchedules)
...
router.get('/trips/diagnostic', getDiagnostic)
router.get('/trips/anomalies', getAnomalyHistory)
...
router.get('/supervisor/map', getSupervisorMap)

router.get('/driver/leaderboard', getDriverLeaderboard)
router.get('/driver/leaderboard/excel', exportLeaderboardExcel)
...
router.get('/coverage/day', getDayCoverage)
