...
export async function getVehicleIntervals(req: AuthRequest, res: Response, next: NextFunction) {
  try {
...
export async function createInterval(req: AuthRequest, res: Response, next: NextFunction) {
  try {
    const { id: vehicleId } = req.params;
    const {
      serviceType,
...
export async function updateInterval(req: AuthRequest, res: Response, next: NextFunction) {
  try {
    const { id } = req.params;
...
export async function getDueIntervals(req: AuthRequest, res: Response, next: NextFunction) {
  try {
...
export async function updateVehicleOdometer(req: AuthRequest, res: Response, next: NextFunction) {
  try {
    const { id: vehicleId } = req.params;
...
export async function deleteInterval(req: AuthRequest, res: Response, next: NextFunction) {
  try {
    const { id } = req.params;
    const interval = await prisma.serviceInterval.findUnique({
      where: { id },
