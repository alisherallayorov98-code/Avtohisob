...
import { getFuelRecords, getFuelRecord, createFuelRecord, updateFuelRecord, deleteFuelRecord, getVehicleFuelRecords, getFuelReport, getFuelRecord_stats, getFuelNormAnalysis, getFuelTankBalance, backfillFuelCosts, getKmUtilization, getKmForecast, getFuelControl } from '../controllers/fuel'
...
router.get('/km-utilization', getKmUtilization)
router.get('/km-forecast', getKmForecast)
router.get('/fuel-control', getFuelControl)
