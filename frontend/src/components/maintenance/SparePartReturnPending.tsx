                    ...
                    <div className="flex gap-2 flex-wrap">
                      {r.evidence.map(ev => (
                        <a key={ev.id} href={ev.fileUrl} target="_blank" rel="noopener noreferrer">
                          <img src={ev.fileUrl} alt="evidence" className="w-32 h-32 object-cover rounded-lg border border-gray-200 dark:border-gray-600 hover:opacity-90 transition-opacity" />
                        </a>
                      ))}
                    </div>
                  )}
