...
export default function RoutePanel({
  ...
  return (
    <div className="absolute top-16 left-3 z-[1000] bg-eko-surface rounded-eko-lg shadow-eko-lg border border-eko-line w-72 max-h-[60vh] flex flex-col">
      <div className="flex items-center justify-between px-3 py-2.5 border-b border-eko-line shrink-0">
      ...
      {/* Tartib usuli */}
      <div className="flex gap-1 px-3 py-2 border-b border-eko-line shrink-0">
        <button
      ...
      {ordered.length === 0 ? (
        ...
        <>
          ...
          <div className="px-3 py-2 border-t border-eko-line text-[11px] text-gray-500 shrink-0">
          ...
          <div className="flex gap-1.5 px-3 pb-3 pt-1 shrink-0">
            ...
            <button
              onClick={onClear}
              className="px-2 py-2 border border-eko-line text-gray-400 hover:text-red-500 rounded-lg"
