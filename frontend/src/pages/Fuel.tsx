...
export default function Fuel() {
  ...
  // Sarf hisoboti — 100 km ga endi alohida sahifada (/fuel-consumption)
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          {isManager && (
            <Link to="/fuel-consumption" className="inline-flex items-center gap-1.5 px-3 py-2 text-sm border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300">
              <TrendingUp className="w-4 h-4" /> Sarf hisoboti
            </Link>
          )}
