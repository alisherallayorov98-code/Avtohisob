      ...
      <section id="tariflar" className="py-24 bg-slate-50 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12 reveal">
            ...
            <p className="text-lg text-slate-600">Faqat <strong className="text-slate-900">mashina soniga</strong> to'laysiz — filial va xodim cheksiz. Aniq narxlarni <strong className="text-slate-900">ro'yxatdan o'tib</strong> "Obunalar" bo'limida ko'rasiz yoki demo so'rang.</p>
          </div>
          ...
          <div className="max-w-4xl mx-auto reveal">
            <div className="glass-card bg-white rounded-3xl border-slate-200 p-8 md:p-12">
              ...
              <div className="bg-brand-50 border border-brand-100 rounded-2xl p-6 text-center">
                ...
                <p className="text-slate-700 mb-6">Avval <strong>14 kun bepul</strong> sinab ko'ring (karta talab qilinmaydi). Aniq narxlar ro'yxatdan o'tgach <strong>"Obunalar"</strong> bo'limida ko'rinadi.</p>
